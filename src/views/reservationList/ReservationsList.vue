  ...
  <div class="reservation-page">
    ...
    <div class="container">
      <div class="reservation-page__list">
        <AddBranchModal class="reservation-page__add-branch" :reservationList="reservationList"
        ...
        <table class="table" v-else>
          ...
          <tbody>
            <tr v-for="(branch, index) in reservationList" :key="index">
              ...
              <td v-if="branch.reservation_duration && branch.accepts_reservations">
...
export default {
  ...
  methods: {
    async getBranchesListing() {
      ...
      return await axios.get('branches?include[0]=sections&include[1]=sections.tables', {
        headers: {
        ...
        if (result.status === 200) {
          ...
          if (this.reservationList.every(list => list.accepts_reservations === false)) {
